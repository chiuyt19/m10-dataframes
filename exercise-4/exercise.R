...
wealthy.org<-grants$organization[grants$total_amount==max.grant]

# Which organization received the smallest grant?
poor.org<-grants$organization[grants$total_amount==min.grant]

# How many grants were awarded in 2010?
table(grants$start_year==2010)['TRUE']
